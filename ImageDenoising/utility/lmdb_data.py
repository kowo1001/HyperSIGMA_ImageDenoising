...
def createDCmall():
    print('create wdc...')
    datadir = '/data/jwjang/project/hsi_foundation/HyperSIGMA/ImageDenoising/utility/WDC/train/'
    fns = os.listdir(datadir) 
    ...
    # )
    create_lmdb_train(
        datadir, fns, '/data/jwjang/project/hsi_foundation/HyperSIGMA/ImageDenoising/utility/WDC/wdc', 'data',  # your own dataset address
        crop_sizes=None,
        scales=(1, 0.5, 0.25),        
        ksizes=(191, 64, 64),
        strides=[(191, 16, 16), (191, 8, 8), (191, 8, 8)],          
